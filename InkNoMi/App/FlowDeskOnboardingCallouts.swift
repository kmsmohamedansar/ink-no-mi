...
struct FlowDeskOnboardingTipCard: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel("Ink no Mi tips")
    }
}
...
struct FlowDeskHomeOnboardingCallout: View {
    ...
    var body: some View {
        FlowDeskOnboardingTipCard(
            title: "Welcome",
            tips: [
                "Two starter boards are in the sidebar—open Welcome to Ink no Mi to explore, or Scratch for an empty canvas.",
    ...
    var body: some View {
        FlowDeskOnboardingTipCard(
            ...
            tips: [
                ...
                "Copy and paste (⌘C / ⌘V) apply to canvas items you copied in Ink no Mi—not plain text from other apps.",
