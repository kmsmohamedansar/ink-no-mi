            ...
            elements: [
                CanvasElementRecord(
                    ...
                    textBlock: TextBlockPayload(
                        text: "Welcome to Ink no Mi. Double-click text to edit. Drag empty space to pan; pinch on a trackpad to zoom. Add items with the tools on the left; use Export in the toolbar for PNG or PDF.",
                        fontSize: 17,
                        isBold: true,
                        color: .defaultText,
                        alignment: .leading
